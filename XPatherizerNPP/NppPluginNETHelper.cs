...
namespace NppPluginNET
{
    ...
    public class Win32
    {
        ...
        [DllImport("kernel32")]
        public static extern int GetPrivateProfileString(string lpAppName, string lpKeyName, string nDefault, StringBuilder lpReturnString, int nSize, string lpFileName);
        [DllImport("kernel32")]
